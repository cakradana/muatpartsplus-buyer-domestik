  ...
  return (
    <div className="flex w-full items-center justify-between gap-x-4">
      <div className="flex w-full items-center gap-x-2">
        <HeaderButtonBack onClick={handleBackButton} variant="muatmuat" />
        ...
        <Input
          ...
          icon={{
            left: <IconComponent src="/icons/search-grey.svg" />,
            right: searchValue ? (
              <IconComponent
        ...
        <div className="flex items-center">
          {withMenu?.onClickPeriod ? (
            ...
            >
              ...
              <span className="text-xxs font-semibold leading-none text-white">
                Periode
              </span>
            </button>
          ) : null}
