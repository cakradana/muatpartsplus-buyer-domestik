...
const backgroundStyles = {
  ...
  muatpartsplus: "bg-muat-parts-member-900",
};
 ...
 * @property {"muatmuat" | "muattrans" | "muatpartsplus"} type
 */
...
export const HeaderButtonBack = ({ onClick, variant }) => {
  return (
    ...
    >
      <IconComponent
        src="/icons/chevron-left-plus.svg"
        width={7}
        height={13}
        className="-ml-[1.5px] -mt-[0.5px]"
        color={variant === "muatmuat" ? "primary" : undefined}
      />
    </button>
  );
};
