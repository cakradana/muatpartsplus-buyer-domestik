...
const Button = ({
  ...
  // Map the text color classes to IconComponent color prop values
  const iconColorMap = {
    "text-neutral-900": "primary",
    "text-muat-trans-secondary-900": "secondary",
    "text-white": "white",
    "text-primary-700": "primary",
    "text-error-400": "danger",
    "icon-gray": "gray",
  };

  const iconColorProp = iconColorMap[iconColorClass] || "default";
