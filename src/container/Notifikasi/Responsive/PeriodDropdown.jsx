...
const PeriodDropdown = ({ isOpen, setIsOpen, options, onChange }) => {
  ...
  const handleApplyPeriodFilter = () => {
    ...
    if (tempValue === "custom" && !startDate) {
      setError({
        startDate: t(
          "PeriodDropdown.messageErrorPeriodeAwalHarusDiisi",
          {},
    ...
    if (tempValue === "custom" && startDate && !endDate) {
      setError({
        endDate: t(
          "PeriodDropdown.messageErrorPeriodeAkhirHarusDiisi",
          {},
    ...
    <BottomSheet open={isOpen} onOpenChange={setIsOpen}>
      <BottomSheetContent>
        <BottomSheetHeader>
          <BottomSheetClose />
          <BottomSheetTitle>
            {t("PeriodDropdown.titlePilihPeriode", {}, "Pilih Periode")}
          </BottomSheetTitle>
        </BottomSheetHeader>
        <div className="flex h-[380px] flex-col gap-y-4 overflow-y-auto px-4">
          ...
          <div className="flex w-full items-center justify-between">
            <span className="text-sm font-semibold leading-[1.1] text-neutral-900">
              {t("PeriodDropdown.labelPilihPeriode", {}, "Pilih Periode")}
            </span>
            <RadioButton
              name="custom"
              value="custom"
          ...
          <div className="flex flex-col gap-y-3">
            <div className="flex items-center gap-x-3">
              <DatePickerResponsive
                ...
                placeholder={t(
                  "PeriodDropdown.placeholderPeriodeAwal",
                  {},
                  "Periode Awal"
                )}
              ...
              <DatePickerResponsive
                ...
                onChange={setEndDate}
                placeholder={t(
                  "PeriodDropdown.placeholderPeriodeAkhir",
                  {},
                  "Periode Akhir"
                )}
        ...
        <BottomSheetFooter>
          ...
          >
            {t("PeriodDropdown.buttonTerapkan", {}, "Terapkan")}
          </Button>
        </BottomSheetFooter>
      </BottomSheetContent>
    </BottomSheet>
