...
function FormLegalDagangDistributorScreen() {
    ...
    >
      ...
      <div className="pb-20">
        <div className="mt-6 flex flex-col gap-y-6">
          ...
          <FormLegalDagangDistributorContent />
        </div>
      </div>
...
function FormLegalDagangDistributorContent() {
  return (
    <>
      ...
      <hr className="border-neutral-400" />
      <p>Legalitas Dagang</p>
      <InputBrand penunjukkanKeagenan />
      <InputFile label={"Daftar Produk"} isRequired={true} />
    </>
  );
}

export default FormLegalDagangDistributorScreen;
