...
function FormLegalDagangImportirScreen() {
    ...
    >
      ...
      <div className="pb-20">
        <div className="mt-6 flex flex-col gap-y-6">
          ...
          <FormLegalDagangImportirContent />
        </div>
      </div>
...
function FormLegalDagangImportirContent() {
  return (
    <>
      ...
      <InputBrand keteranganAsal />
      <InputFile label={"Daftar Produk"} isRequired={true} />
    </>
  );
}

export default FormLegalDagangImportirScreen;
