...
function FormLegalDagangManufakturScreen() {
    ...
    >
      ...
      <div className="pb-20">
        <div className="mt-6 flex flex-col gap-y-6">
          ...
          <FormLegalDagangManufakturContent />
        </div>
      </div>
...
function FormLegalDagangManufakturContent() {
  return (
    <>
      ...
      <InputBrand sertifikatHaki />
      <InputFile label={"Daftar Produk"} isRequired={true} />
    </>
  );
}

export default FormLegalDagangManufakturScreen;
